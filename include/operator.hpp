...
// DIAGONALIZATION : 
    ...
    void FOLM_diag(Eigen::SparseMatrix<double> O, int nb_iter, Eigen::VectorXd& v_0, Eigen::MatrixXd& T, Eigen::MatrixXd& V);
...
// DIAGONALIZATION : 
    ...
    */
    Eigen::VectorXd FOLM_eigen(Eigen::SparseMatrix<double> O, int nb_iter, Eigen::MatrixXd& eigenvectors);
